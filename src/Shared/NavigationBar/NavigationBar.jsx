        ...
        <div className="navbar bg-gradient-to-r md:px-5 from-cyan-300 to-cyan-600 ">
            <div className="navbar-start ">
                ...
                <div>
                    ...
                    <h1 className="font-bold flex items-center w-full"><span className="text-2xl text-gradient flex items-center">  <img className="w-6 mr-2" src={`https://ibb.co/BCk2yZJ`} alt="" />  Jungle</span>  <sub className="font-mono md:w-0 w-1 text-sm ml-1"><small>Jamboree</small></sub></h1>
                </div>
            </div>
